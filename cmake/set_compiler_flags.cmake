macro(set_compiler_flags)
    ...
    if(COMPILER_NAME STREQUAL ifort)
        ...
        elseif(APPLE)
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                set(CMAKE_Fortran_FLAGS_DEBUG "-g -warn -cpp -qdiag-disable:10448 -qopt-report=0 -fPIC")
                set(OPT_FLAGS  "-g")
                set(OPT_FLAGS1 "-g")
                set(OPT_FLAGS0 "-O0")
		        set(OPT_FLAGS2 "-O1")
            elseif(CMAKE_BUILD_TYPE STREQUAL Release)
                set(CMAKE_Fortran_FLAGS_RELEASE "-warn -cpp -diag-disable=10448 -qopt-report=0 -fPIC")
                set(OPT_FLAGS0 "-O0")
                set(OPT_FLAGS  "-O2")
                set(OPT_FLAGS1 "-O0")
                set(OPT_FLAGS2 "-O1")
            ...
            if(CMAKE_BUILD_TYPE STREQUAL Debug)
                set(CMAKE_Fortran_FLAGS_DEBUG "-g -warn -cpp -diag-disable=10448 -qopt-report=0 -fPIC")
                set(OPT_FLAGS  "-g")
                set(OPT_FLAGS1 "-g")
                set(OPT_FLAGS0 "-O0")
		set(OPT_FLAGS2 "-O1")
