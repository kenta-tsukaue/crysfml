    ...
    Subroutine Write_FST_VESTA()
      ...
      if(ok) then
        ...
        if(replace_files) then
            Call getfnm(filenam,outfile, '_flts.cif', ok,replace_files)
        else
      ...
      contains
        Subroutine Write_Vesta_File()
           ...
           if(replace_files) then
                Call getfnm(filenam,outfile, '_flts.vesta', ok,replace_files)
           else
           ...
           if(replace_files) then
               ...
               write(unit=lun,fmt="(a)") trim(outfile_notrepl)//"_flts.cif"
           end if
           write(unit=lun,fmt="(a)") " "
