...
rem ****---- Lahey Compiler ----****
:LF95
   lf95 -c Simple_Calc_Powder.f90    -info  -o1 -chk -mod ".;..\..\lahey\libC"
   lf95 *.obj -out Simple_Calc_Powder_lf  -o1 -lib ..\..\lahey\libC\crysFML
   goto END
rem
rem ****---- Intel Compiler ----****
:IFORT
...
rem **---- G95 Compiler ----**
:G95
   g95 -c -O3  -std=f2003  -funroll-loops  -msse2   Simple_calc_powder.f90   -I..\..\G95\LibC
   g95  *.o -o Simple_calc_powder_g95 -O3  -funroll-loops  -msse2  -L..\..\G95\LibC -lcrysfml  -Wl,--heap=0x01000000
   goto END
rem
