...
then
cat << !
make_cryscalc : Make the cryscalcon Program for Absoft/G95/GFortran/Intel/Lahey Compilers (MacOS)
...
in
  ...
  'gfortran')
     ...
     ;;
  'ifort')
     $COMP *.o -o cryscalcon -static-intel -m64 $LIB $LIBSTATIC
     ;;
  'lf95')
